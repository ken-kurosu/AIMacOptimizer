...
const ja = {
  ...
  decompose: "✦ モチーフを分解",
  decomposing: "分解中…",
  decomposeTitle: "背景の装飾を「動かせるモチーフ画像 + 無地背景」に分解します(1〜2分)",
...
const en: Record<keyof typeof ja, string> = {
  ...
  aiEdit: "AI edit",
  decompose: "✦ Split motifs",
  decomposing: "Splitting…",
  decomposeTitle: "Splits the background art into movable motif parts + a clean backdrop (1–2 min)",
