...
const ja = {
  ...
  makePlan: "構成案を見る",
  planning: "構成を考えています…(1〜2分)",
  generatingShort: "生成中…",
  reviewCount: "この内容で{n}ページ生成します",
  planBy: "構成:",
  feedbackPlaceholder: "修正したい点があれば書いて「作り直す」(例: 5ページに収めて / 3ページ目は事例に)",
  backToInput: "← 入力に戻る",
  remake: "作り直す",
  remaking: "作り直し中…",
  ...
  openFileTitle: "JSONはそのまま、PDFは編集可能なデッキに分解。テキストPDFは文字を元の位置・サイズ・フォントのまま打ち直せます(画像のみPDFはAIで文字を読み取り)",
  importingPdf: "PDFを分解中…(ページ数×最大1分)",
  ...
  decompose: "✦ レイヤーに分解",
  decomposing: "分解中…",
  decomposeTitle: "この背景を、動かせる画像レイヤー(オブジェクト単位)に分解します。編集したいページだけ実行してください(1〜2分)",
  decomposeHint: "背景を動かせる画像に分解して編集可能に。編集したいページだけ実行(1〜2分)",
  layersLabel: "レイヤー",
  layerBg: "背景",
  decomposeFailed: "分解に失敗しました",
  slideName: "スライド名",
  editorHint:
    "要素をクリックすると詳細を編集できます。ダブルクリックでテキストを直接編集、ドラッグで移動できます。Cmd/Shift+クリックや背景ドラッグで複数選択できます。",
  // 複数選択
  layersSelectedSuffix: "個のレイヤーを選択中",
  dupAll: "まとめて複製",
  delAll: "まとめて削除",
  alignSection: "整列",
  alignL: "左",
  ...
  alignB: "下",
  multiHint:
    "ドラッグで一緒に移動できます。Cmd/Shift+クリックで選択を増減、矢印キーで微調整、Delで一括削除。",
  textEl: "テキスト",
  shapeEl: "図形",
  imageEl: "画像",
  toBack: "背面へ",
...
const en: Record<keyof typeof ja, string> = {
  ...
  openFileTitle: "JSON loads as-is; PDFs become an editable deck. Text PDFs keep each line's original position, size and font so you just retype; image-only PDFs are OCR'd by AI",
  importingPdf: "Decomposing PDF… (up to ~1 min/page)",
  ...
  decomposeTitle: "Split this background into movable, per-object image layers. Run it only on pages you want to edit (1–2 min)",
  decomposeHint: "Turn the background into movable images you can edit — run only on the pages you need (1–2 min)",
  layersLabel: "Layers",
  layerBg: "Background",
  decomposeFailed: "Decomposition failed",
  slideName: "Slide name",
  editorHint:
    "Click an element to edit its details. Double-click to edit text inline, drag to move. Cmd/Shift-click or drag the background to multi-select.",
  layersSelectedSuffix: " layers selected",
  dupAll: "Duplicate all",
  delAll: "Delete all",
  alignSection: "Align",
  alignL: "Left",
  alignCH: "Center H",
  ...
  alignB: "Bottom",
  multiHint:
    "Drag to move them together. Cmd/Shift-click to add/remove, arrow keys to nudge, Del to delete all.",
  textEl: "Text",
  shapeEl: "Shape",
  imageEl: "Image",
